...
balsamncedar56301@c5r8s4 cdy_E1_1 % vim README.md

balsamncedar56301@c5r8s4 cdy_E1_1 % cat README.md
...
```bash
$ mv practice/memo_backup.txt site/moved_memo.txt
$ cd ../site/
$ ls -al
```
...
```bash
$ touch sample.txt && echo Hello this is sample text in sample.txt  >> sample.txt
$ ls
$ cat ../logs/terminal_basics.log
```
...
total 16
drwxr-xr-x  4 balsamncedar56301  balsamncedar56301  128 Jul 28 00:13 .
drwxr-xr-x  7 balsamncedar56301  balsamncedar56301  224 Jul 27 23:50 ..
-rw-r--r--  1 balsamncedar56301  balsamncedar56301 15 Jul 27 23:41 moved_memo.txt
-rw-r--r--  1 balsamncedar56301  balsamncedar56301 40 Jul 28 00:13 sample.txt
Hello this is sample text in sample.txt
```
* 이미지
...
drwxr-xr-x 7 balsamncedar56301  balsamncedar56301  224 Jul 27 23:50 .
drwxr-xr-x 3 balsamncedar56301  balsamncedar56301 96 Jul 27 23:41 ..
drwxr-xr-x  12 balsamncedar56301  balsamncedar56301  384 Jul 28 03:55 .git
-rw-r--r-- 1 balsamncedar56301  balsamncedar56301  476 Jul 27 23:41 README.md
drwxr-xr-x 3 balsamncedar56301  balsamncedar56301 96 Jul 28 04:04 logs
drwxr-xr-x 4 balsamncedar56301  balsamncedar56301  128 Jul 28 00:36 practice
drwxrwxrwx 4 balsamncedar56301  balsamncedar56301  128 Jul 28 00:13 site
```
