...
> [!NOTE]
> (권한)       (링크수)      (소유자)             (그룹)             (용량)       (마지막 수정시간)       (파일 혹은 디렉토리 이름)
> drwxr-xr-x   3         balsamncedar56301  balsamncedar56301   96         Jul 29 11:55           docker-test
> drwxr-xr-x (권한)  /  d : 디렉토리  / - 일반파일    / r(4) w(2) x(1) - 숫자로 표현하기도합니다. / 3 개로 나뉨 (소유자 / 그룹 / 기타)
> 3 (링크 수) : 해당 파일/폴더와 연결된 하드 링크의 갯수 (보통 폴더는 2개이상)
> balsamncedar56301(계정명) : 이 파일의 주인(계정명)
> balsamncedar56301(그룹) : 이 파일이 속한 그룹의 이름
> 96 (용량) : 파일의 크기 (단위: 바이트)
> Jul 29 11:55 (수정시간)
>  docker-test (이름)
